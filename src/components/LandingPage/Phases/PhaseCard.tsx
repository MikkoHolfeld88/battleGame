...
const PhaseCard: React.FC<PhaseCardProps> = ({ phaseNumber, title, description, imageUrl, imageAlt }) => {
  return (
    <Card sx={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
      {imageUrl && (
        <CardMedia
          component="img"
          // sx={{ height: 180 }} // Fixed height, or use aspect ratio
          sx={{
            height: 200, // Adjust as needed
            objectFit: 'cover', // Or 'contain'
            // For pixelated effect if images are scaled up by browser:
            imageRendering: 'pixelated',
            // Fallbacks for other browsers (already in theme.ts for global .phase-image but good for specific components too)
            // imageRendering: '-moz-crisp-edges', /* Firefox */
            // imageRendering: 'crisp-edges', /* Chrome, Edge, Opera */
            backgroundColor: 'grey.300' // Placeholder if image fails to load
          }}
          image={imageUrl || `https://via.placeholder.com/600x400.png?text=Phase+${phaseNumber}+Art`}
          alt={imageAlt || `Concept art for ${title}`}
        />
      )}
...
export const Phase1Gathering: React.FC = () => (
  <PhaseCard
    ...
    imageUrl="placeholder_phase1.png" // Replace with actual or better placeholder
  />
);
...
export const Phase2Growing: React.FC = () => (
  <PhaseCard
    ...
    imageUrl="placeholder_phase2.png"
  />
);
...
export const Phase3Weapons: React.FC = () => (
  <PhaseCard
    ...
    imageUrl="placeholder_phase3.png"
  />
);
...
export const Phase4Teaching: React.FC = () => (
  <PhaseCard
    ...
    imageUrl="placeholder_phase4.png"
  />
);
...
export const Phase5Training: React.FC = () => (
  <PhaseCard
    ...
    imageUrl="placeholder_phase5.png"
  />
);
...
export const Phase6Battles: React.FC = () => (
  <PhaseCard
    ...
    imageUrl="placeholder_phase6.png"
  />
);
...
export default PhaseCard; // Export default for the generic card, named exports for specific phases
// Individual files for each phase component (e.g. Phase1Gathering.tsx) are not strictly necessary
// if they are simple wrappers around PhaseCard as shown above.
// However, if they were to have more unique logic or layout, separate files would be better.
// For this step, keeping them here is fine. The plan mentioned "separate React component",
// which these are, even if defined in the same file.
// If the user prefers separate files, I can move them.
